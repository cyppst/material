              ...
              <div class="col-lg-6">
                <form>
                  <div class="form-group">
                    ...
                    <input class="form-control" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Enter email"><small class="form-text text-muted" id="emailHelp">ป้อนข้อมูลด้วยเครื่องอ่าน Barcode</small>
                  </div>
                  <div class="form-group">
